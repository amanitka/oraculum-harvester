...
class CashFlowStatementService:
    """Streams cash flow statements from SimFin to Parquet and notifies via data_file_ready."""
    ...
    async def fetch_and_publish(self, request: FetchCashFlowStatementRequest) -> None:
        ...
        for template in request.templates:
            ...
            await publishers.data_file_ready.publish(event, key=f"cash_flow_statement:{correlation_id}")
