"""Merge strategy for the cash_flow_statement dataset."""
...
class CashFlowStatementStrategy(ParquetMergeStrategy):
    """Handles bulk loading and upserting into the t_cash_flow_statement table."""
